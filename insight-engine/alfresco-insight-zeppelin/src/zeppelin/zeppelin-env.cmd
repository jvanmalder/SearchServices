...
REM The default values for ZEPPELIN_NOTEBOOK_PUBLIC and ZEPPELIN_CREDENTIALS_PERSIST have been set to false programmatically
set ZEPPELIN_PORT=${zeppelin.port}
set ZEPPELIN_SERVER_CONTEXT_PATH=${zeppelin.server.context.path}