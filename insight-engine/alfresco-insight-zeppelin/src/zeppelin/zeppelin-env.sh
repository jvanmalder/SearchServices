...
# The default values for ZEPPELIN_NOTEBOOK_PUBLIC and ZEPPELIN_CREDENTIALS_PERSIST have been set to false programmatically
export ZEPPELIN_PORT=${zeppelin.port}
export ZEPPELIN_SERVER_CONTEXT_PATH=${zeppelin.server.context.path}